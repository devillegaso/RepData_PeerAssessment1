...
hist(dailytotal$x,breaks=nrow(dailymean),xlab="Total daily number of steps",main="Histogram of total daily number of steps")
...
```{r echo=TRUE}
par(mfcol=c(2,1))
hist(dailymean$x,breaks=nrow(dailymean2),xlab="Daily mean number of steps",main="Histogram of daily mean number of steps")
hist(dailymedian$x,breaks=nrow(dailymedian2),xlab="Daily median number of steps",main="Histogram of daily median number of steps")
```
